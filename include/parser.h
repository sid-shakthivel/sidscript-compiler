...
private:
    ...
    std::vector<TokenType> addressable_types = {TOKEN_INT, TOKEN_LONG, TOKEN_UNSIGNED, TOKEN_SIGNED, TOKEN_DOUBLE, TOKEN_STAR, TOKEN_CHAR_TEXT, TOKEN_STRUCT, TOKEN_BOOL};
